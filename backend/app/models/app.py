...
class App(Base, TimestampMixin):
    ...
    package_id = Column(String(150), unique=True, nullable=False)  # e.g., "com.aistudio.biblia.nvgtnt"
...
class AppConfig(Base, TimestampMixin):
    ...
    authentication_system_enabled = Column(Boolean, default=True, nullable=False)
    login_enabled = Column(Boolean, default=True, nullable=False)
    local_auth_enabled = Column(Boolean, default=True, nullable=False)
    google_auth_enabled = Column(Boolean, default=False, nullable=False)
    google_auth_status = Column(String(20), default="coming_soon", nullable=False)  # "enabled", "disabled", "coming_soon"
    logout_enabled = Column(Boolean, default=True, nullable=False)
