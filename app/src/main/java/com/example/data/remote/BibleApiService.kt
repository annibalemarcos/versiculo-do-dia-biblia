...
interface BibleApiService {
    ...
    suspend fun getRegistrationFields(@Query("app_id") appId: String = "verse_daily"): Response<ApiResponse<List<RegistrationFieldDto>>>
    ...
    @POST("billing/dev-simulate")
    suspend fun devSimulateBilling(@Body request: DevSimulateRequest): Response<ApiResponse<BillingStatusData>>
    ...
    suspend fun getBanners(
        @Query("app_id") appId: String = "verse_daily",
