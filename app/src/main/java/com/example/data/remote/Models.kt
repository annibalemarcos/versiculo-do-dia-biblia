...
data class TestEnvironmentDto(
    ...
    @Json(name = "title") val title: String = "Ambiente de Testes: Simulação de Assinatura",
    @Json(name = "description") val description: String = "Este painel só funciona em ambiente de teste/debug e valida a autoridade do servidor sem burlar a Google Play em produção.",
    @Json(name = "button_activate_text") val buttonActivateText: String = "Ativar (24h)",
    @Json(name = "button_expire_text") val buttonExpireText: String = "Expirar",
    @Json(name = "button_reset_text") val buttonResetText: String = "Resetar para Gratuito",
    @Json(name = "default_duration_hours") val defaultDurationHours: Int = 24,
    @Json(name = "visible_to") val visibleTo: String = "all",
    @Json(name = "app_mode") val appMode: String = "TEST"
)
...
data class PremiumProductDto(
    ...
    @Json(name = "reference_price") val referencePrice: String? = null,
...
data class AppConfigData(
    ...
    @Json(name = "test_environment") val testEnvironment: TestEnvironmentDto? = null,
...
data class UserRegisterRequest(
    ...
    @Json(name = "platform") val platform: String = "android",
    @Json(name = "app_id") val appId: String = "verse_daily",
    @Json(name = "custom_fields") val customFields: Map<String, Any> = emptyMap()
)
...
data class BillingStatusData(
    @Json(name = "is_premium") val isPremium: Boolean = false,
    @Json(name = "status") val status: String = "FREE",
    @Json(name = "source") val source: String = "NONE",
    @Json(name = "premium_expires_at") val premiumExpiresAt: String? = null,
...
data class VerifyPurchaseRequest(
    ...
    @Json(name = "package_name") val packageName: String? = "com.aistudio.biblia.nvgtnt"
)

@JsonClass(generateAdapter = true)
data class VerifyPurchaseData(
    @Json(name = "status") val status: String = "verified",
    @Json(name = "source") val source: String = "GOOGLE_PLAY",
...
data class RestorePurchasesRequest(
    @Json(name = "purchase_tokens") val purchaseTokens: List<String> = emptyList()
)
...
@JsonClass(generateAdapter = true)
data class DevSimulateRequest(
    @Json(name = "action") val action: String = "activate",
    @Json(name = "product_id") val productId: String? = "premium_yearly",
...
// ==========================================
// REGISTRATION FIELDS (DYNAMIC FIELDS)
// ==========================================

@JsonClass(generateAdapter = true)
data class RegistrationFieldOptionDto(
    @Json(name = "value") val value: String,
    @Json(name = "label") val label: String? = null
)

@JsonClass(generateAdapter = true)
data class RegistrationFieldDto(
    @Json(name = "id") val id: String,
    ...
    @Json(name = "min_length") val minLength: Int? = null,
    @Json(name = "max_length") val maxLength: Int? = null,
    @Json(name = "regex_pattern") val regexPattern: String? = null,
    @Json(name = "error_message") val errorMessage: String? = null,
    @Json(name = "display_order") val displayOrder: Int = 0,
    @Json(name = "show_in_profile") val showInProfile: Boolean = true
)
...
data class BannerItemDto(
    ...
    @Json(name = "placement") val placement: String = "home_top",
    @Json(name = "action_type") val actionType: String = "open_url",
    @Json(name = "action_url") val actionUrl: String? = null,
    @Json(name = "action_label") val actionLabel: String? = "Saiba Mais",
    @Json(name = "secondary_action_label") val secondaryActionLabel: String? = null,
    @Json(name = "priority") val priority: Int = 10,
    @Json(name = "dismissible") val dismissible: Boolean = true,
