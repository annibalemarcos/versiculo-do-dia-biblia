...
export interface AppConfigData {
  ...
  authentication_system_enabled?: boolean;
  login_enabled?: boolean;
  local_auth_enabled?: boolean;
  google_auth_enabled?: boolean;
  google_auth_status?: 'enabled' | 'disabled' | 'coming_soon';
...
export interface RegistrationFieldItem {
  ...
  options?: (string | RegistrationFieldOption)[];
  is_required: boolean;
  is_active: boolean;
  min_length?: number;
  max_length?: number;
...
export interface RegistrationFieldCreatePayload {
  app_id: string;
  field_key: string;
  label: string;
  placeholder?: string;
...
export interface RegistrationFieldUpdatePayload {
  label?: string;
  placeholder?: string;
  help_text?: string;
  field_type?: RegistrationFieldType;
